...
<body>
  ...
  <!-- Share section -->
  <div class="no-print" style="margin-top:32px;padding:20px 24px;background:#f0fdfa;border:2px solid #0d9488;border-radius:12px;text-align:center">
    <p style="font-size:15px;font-weight:700;color:#1E3A5F;margin-bottom:12px">📤 Comparte este memorándum</p>
    <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap">
      <a id="wa-share" href="#" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:6px;padding:10px 20px;background:#25D366;color:white;text-decoration:none;border-radius:8px;font-size:13px;font-weight:700">
      ...
      <button onclick="navigator.clipboard.writeText(window.location.href).then(()=>{this.textContent='✅ Enlace copiado'})" style="display:inline-flex;align-items:center;gap:6px;padding:10px 20px;background:#1E3A5F;color:white;border:none;border-radius:8px;font-size:13px;font-weight:700;cursor:pointer">
        📋 Copiar enlace
      </button>
    </div>
  </div>
  <script>
    (function(){
      var msg = "Mira este memorándum de inversión generado con PropAdvisor:\\n" + document.title + "\\n\\n" + window.location.href;
  ...
  <div class="disclaimer">
    <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
      <span style="font-size:20px;font-weight:800;color:#1E3A5F">PropAdvisor</span>
      <span style="font-size:11px;font-weight:700;color:#0d9488;background:#ccfbf1;padding:2px 6px;border-radius:4px">CL</span>
    </div>
    Generado con <a href="https://www.propadvisor.site" style="color:#0d9488;font-weight:600">PropAdvisor CL</a> — Análisis inmobiliario inteligente para Chile.<br>
    Supuestos: plusvalía 7%/año, arriendo sube 3%/año, vacancia 5%, gastos estándar.<br>
